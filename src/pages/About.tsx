    ...
    return (
        <div>
            <div className='intro-flexbox'>
                <div className='item'>
                <h1>Tony A. Cui</h1>
                <p>Hello! I'm a first year M.Eng student studying Computer Science at MIT. Currently, I'm researching Machine Learning Algorithms Computational Genomics at the <a href='https://www.broadinstitute.org/'>Broad Institute</a>. </p>
